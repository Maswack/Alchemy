execute as @s at @s run summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Mikstura Spowolnienia I","color":"gray","bold":true}'},AC_Potion:1b,AC_Slowness_I:1b,CustomPotionEffects:[{Id:2,Amplifier:0b,Duration:1200}],CustomPotionColor:2635067}}}
