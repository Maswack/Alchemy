execute as @s at @s run summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Mikstura Zatrucia I","color":"dark_green","bold":true}'},AC_Potion:1b,AC_Poison_I:1b,CustomPotionEffects:[{Id:19,Amplifier:0b,Duration:400}],CustomPotionColor:1867807}}}
