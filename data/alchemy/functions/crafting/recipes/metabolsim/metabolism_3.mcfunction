execute as @s at @s run summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Mikstura Szybkiego Metabolizmu III","color":"blue","bold":true}'},AC_Potion:1b,AC_Metabolism_III:1b,CustomPotionEffects:[{Id:1,Amplifier:1b,Duration:1800},{Id:3,Amplifier:0b,Duration:300},{Id:9,Amplifier:0b,Duration:60},{Id:17,Amplifier:0b,Duration:1200},{Id:19,Amplifier:0b,Duration:200}],CustomPotionColor:5787135}}}
