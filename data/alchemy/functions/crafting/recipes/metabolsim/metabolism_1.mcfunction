execute as @s at @s run summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Mikstura Szybkiego Metabolizmu I","color":"blue","bold":true}'},AC_Potion:1b,AC_Metabolism_I:1b,CustomPotionEffects:[{Id:1,Amplifier:0b,Duration:1200},{Id:17,Amplifier:0b,Duration:1200}],CustomPotionColor:5787135}}}
