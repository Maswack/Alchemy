execute as @s at @s run summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Mikstura Zwinności I","color":"aqua","bold":true}'},AC_Potion:1b,AC_Agility_I:1b,CustomPotionEffects:[{Id:8,Amplifier:0b,Duration:600}],CustomPotionColor:3535047}}}
