execute as @s at @s run summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Mikstura Siły I","color":"red","bold":true}'},AC_Potion:1b,AC_Strength_I:1b,CustomPotionEffects:[{Id:5,Amplifier:0b,Duration:2400},{Id:17,Amplifier:0b,Duration:600}],CustomPotionColor:13048860}}}
