execute as @s at @s run summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Mikstura Sytości I","color":"dark_purple","bold":true}'},AC_Potion:1b,AC_Nourishment_I:1b,CustomPotionEffects:[{Id:23,Amplifier:0b,Duration:180}],CustomPotionColor:8530068}}}
