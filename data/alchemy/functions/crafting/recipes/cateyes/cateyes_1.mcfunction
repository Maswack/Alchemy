execute as @s at @s run summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Mikstura Kocich Oczu I","color":"dark_blue","bold":true}'},AC_Potion:1b,AC_Cateyes_I:1b,CustomPotionEffects:[{Id:16,Amplifier:0b,Duration:1200}],CustomPotionColor:1179829}}}
