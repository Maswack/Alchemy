execute as @s at @s run summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Mikstura Szczęścia I","color":"green","bold":true}'},AC_Potion:1b,AC_Luck_I:1b,CustomPotionEffects:[{Id:26,Amplifier:0b,Duration:1200}],CustomPotionColor:65297}}}
