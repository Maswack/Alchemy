execute as @s at @s run summon item ~ ~ ~ {Item:{id:"minecraft:potion",Count:1b,tag:{display:{Name:'{"text":"Mikstura Leczenia","color":"red","bold":true}'},AC_Potion:1b,AC_Healing_I:1b,CustomPotionEffects:[{Id:10,Amplifier:0b,Duration:300}],CustomPotionColor:16727600}}}
